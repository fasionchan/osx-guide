...
html_theme_options = {
    'logo': 'logo.png',
    #'logo_name': True,
    'description': u'OSX操作指南，涵盖基础操作、开发环境、以及最佳实践。',
...
latex_documents = [
    (master_doc, 'OSX.tex', u'OSX操作指南 Documentation',
     u'陈彦霏', 'manual'),
]
...
man_pages = [
    (master_doc, 'osx', u'OSX操作指南 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OSX', u'OSX操作指南 Documentation',
     author, 'OSX', 'One line description of project.',
     'Miscellaneous'),
]
